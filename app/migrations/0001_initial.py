    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('register_number', models.CharField(max_length=25, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='email_customer', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Email',
