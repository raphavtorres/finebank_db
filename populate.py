...
def create_header():
    access_token = create_jwt(123, '123')
    headers = {'Authorization': f'Bearer {access_token}'}
    return headers


# TABLES POPULATION
def create_natural_person(headers, cpf, password, name, birthdate, rg, social_name):
...
def create_legal_person(headers, cnpj, password, fantasy_name, establishment_date, im, ie, legal_nature):
...
def main():
    ...
    print(create_natural_person(HEADERS, '92154845070', 'test@test',
          'Person1', '2004-03-15', '380959021', social_name=''))
    print(create_natural_person(HEADERS, '96731438030', 'test@test',
          'Person2', '2003-12-02', '147879619', social_name=''))
    print(create_natural_person(HEADERS, '48090331041', 'test@test',
          'Person3', '1980-12-04', '306126618', social_name=''))

    # CREATE LEGAL PERSON
    print(create_legal_person(HEADERS, '72305148000145', 'test@test', 'Company1',
          '2000-12-10', im='33333', ie='925113970461', legal_nature='Comp1Name'))
    print(create_legal_person(HEADERS, '03673451000188', 'test@test', 'Company2',
          '2003-12-02', im='22222', ie='024719352149', legal_nature='Comp2Name'))
    print(create_legal_person(HEADERS, '18716263000167', 'test@test', 'Company3',
          '1980-12-04', im='11111', ie='451925422835', legal_nature='Comp3Name'))

    # CREATE EMAIL
    print(create_email(HEADERS, 'person1@gmail.com', '92154845070'))
    print(create_email(HEADERS, 'person1second@gmail.com', '92154845070'))
    print(create_email(HEADERS, 'company1@gmail.com', '72305148000145'))

    # CREATE PHONE
    print(create_phone(HEADERS, '31212867', country_code='55',
          prefix_number='81', customer='92154845070'))
    print(create_phone(HEADERS, '23766213', country_code='55',
          prefix_number='63', customer='92154845070'))
    print(create_phone(HEADERS, '38203406', country_code='55',
          prefix_number='84', customer='72305148000145'))

    # CREATE ADDRESS
    print(create_address(HEADERS, 'Planalto', 'Treze', '769',
          'Maceió', 'Alagoas', '69121410', '92154845070'))
    print(create_address(HEADERS, 'Centro', 'Duque de Caxias', '28',
          'Teófilo Otoni', 'Minas Gerais', '09769184', '03673451000188'))
    print(create_address(HEADERS, 'São José', 'Bahia', '4225',
          'Bacabal', 'Maranhão', '69387595', '48090331041'))

    # CREATE ACCOUNT - need user authenticated to make relation
    print(create_account(HEADERS, "checking", balance=2000.00))
    print(create_account(HEADERS, "savings", balance=5000.00))

    # CREATE INVESTMENT
    print(create_investment(HEADERS, "Tesouro Direto", 350.00, admin_fee=0.01,
          period="2026-01-01", risc_rate="Baixo", profitability=0.10))
    print(create_investment(HEADERS, "CDB", 200.00, admin_fee=0.02,
          period="2027-01-01", risc_rate="Médio", profitability=0.11))
    print(create_investment(HEADERS, "LCI", 540.00, admin_fee=0.012,
          period="2028-01-01", risc_rate="Alto", profitability=0.12))

    # CREATE ACCOUNT INVESTMENT
    print(create_account_investment(HEADERS, id_investment=1, id_account=2))
    print(create_account_investment(HEADERS, id_investment=3, id_account=2))

    # CREATE LOAN
    print(create_loan(HEADERS, 1, 700, interest_rate=0.05,
          is_payout=False, installment_amount=3, observation="comprar um celular"))
    print(create_loan(HEADERS, 2, 200, interest_rate=0.03,
          is_payout=False, installment_amount=2, observation="comprar um carro"))

    # CREATE CARD
    print(create_card(HEADERS, id_account=1))
    print(create_card(HEADERS, id_account=2))
    print(create_card(HEADERS, id_account=2))

    # CREATE TRANSACTION
    print(create_transaction(HEADERS, id_card=2, id_receiver=1,
